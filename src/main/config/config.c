...
#ifdef AIRWII32
    modeActivationCondition_t *mac = &currentProfile->modeActivationConditions[0];

    mac->modeId = 2;  //horizon
    mac->auxChannelIndex = 0; //aux1
    mac->range.startStep = 0;   //(900-900) / 25
    mac->range.endStep = 48;    //(2100-900) / 25
#endif
